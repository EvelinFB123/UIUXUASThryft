...
<section class="p-6 bg-white">
  <div id="product-list" class="grid grid-cols-2 sm:grid-cols-4 gap-6">
    ...
    <!-- @php
      $products = [
        ['image' => 'oven.jpeg', 'name' => 'Oven', 'price' => '500.000,00'],
        ['image' => 'microwave.jpg', 'name' => 'Microwave', 'price' => '250.000,00'],
        ['image' => 'pan.jpg', 'name' => 'Skillet', 'price' => '50.000,00'],
        ['image' => 'saucepan.jpeg', 'name' => 'Sauce Pan', 'price' => '20.000,00'],
        ['image' => 'pot.jpg', 'name' => 'Pot', 'price' => '27.000,00'],
        ['image' => 'blender.jpeg', 'name' => 'Blender', 'price' => '100.000,00'],
        ['image' => 'Mixer.jpg', 'name' => 'Mixer', 'price' => '100.000,00'],
        ['image' => 'Hand Blender.jpg', 'name' => 'Hand Blender', 'price' => '85.000,00'],
  ...
  $products = App\Models\Product::whereHas('category', function($query) {
    $query->where('name', 'Kitchen Items');
  })->get();
@endphp
